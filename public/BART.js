function get_bart_etds(){
    ...
    Httpreq.open("GET","https://api.bart.gov/api/etd.aspx?cmd=etd&orig=12TH&key=BART_KEY&json=y",false);
    Httpreq.send(null);
...
function get_ac_transit_etd() {
    ...
    acHttpreq.open("GET","http://api.actransit.org/transit/stops/50212/predictions?token=AC_TRANSIT_TOKEN",false);
    acHttpreq.send(null);
